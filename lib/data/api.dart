...
class ApiService {
  final String loginURL =
      "http://ayyildiz.xyz:8090/api/auth/login"; //"https://reqres.in/api/login";
  ...
  Future<UserSignupResponseModel> signin(
      UserSignupRequestModel userSigninRequestModel) async {
    print(userSigninRequestModel.toJson());
    Response res =
        await post(Uri.parse(loginURL), body: userSigninRequestModel.toJson());
